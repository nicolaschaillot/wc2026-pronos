...
export const GROUPS = {
  A: { teams: [
    { id: 'mex', name: 'Mexique',            namesq: 'Meksika',                    flag: '🇲🇽' },
    { id: 'rsa', name: 'Afrique du Sud',     namesq: 'Afrika e Jugut',             flag: '🇿🇦' },
    { id: 'kor', name: 'Corée du Sud',       namesq: 'Koreja e Jugut',             flag: '🇰🇷' },
    { id: 'cze', name: 'Tchéquie',           namesq: 'Çekia',                      flag: '🇨🇿' },
  ]},
  B: { teams: [
    { id: 'can', name: 'Canada',             namesq: 'Kanada',                     flag: '🇨🇦' },
    { id: 'bih', name: 'Bosnie-Herzégovine', namesq: 'Bosnja dhe Hercegovina',     flag: '🇧🇦' },
    { id: 'qat', name: 'Qatar',              namesq: 'Katari',                     flag: '🇶🇦' },
    { id: 'sui', name: 'Suisse',             namesq: 'Zvicra',                     flag: '🇨🇭' },
  ]},
  C: { teams: [
    { id: 'bra', name: 'Brésil',             namesq: 'Brazili',                    flag: '🇧🇷' },
    { id: 'mar', name: 'Maroc',              namesq: 'Maroku',                     flag: '🇲🇦' },
    { id: 'hai', name: 'Haïti',              namesq: 'Haiti',                      flag: '🇭🇹' },
    { id: 'sco', name: 'Écosse',             namesq: 'Skocia',                     flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿' },
  ]},
  D: { teams: [
    { id: 'usa', name: 'États-Unis',         namesq: 'Shtetet e Bashkuara',        flag: '🇺🇸' },
    { id: 'par', name: 'Paraguay',           namesq: 'Paraguaji',                  flag: '🇵🇾' },
    { id: 'aus', name: 'Australie',          namesq: 'Australia',                  flag: '🇦🇺' },
    { id: 'tur', name: 'Turquie',            namesq: 'Turqia',                     flag: '🇹🇷' },
  ]},
  E: { teams: [
  ...
  G: { teams: [
    ...
    { id: 'egy', name: 'Égypte',             namesq: 'Egjipti',                    flag: '🇪🇬' },
    { id: 'irn', name: 'Iran',               namesq: 'Irani',                      flag: '🇮🇷' },
  ...
  I: { teams: [
    { id: 'fra', name: 'France',             namesq: 'Franca',                     flag: '🇫🇷' },
    { id: 'sen', name: 'Sénégal',            namesq: 'Senegali',                   flag: '🇸🇳' },
    { id: 'irq', name: 'Irak',               namesq: 'Iraku',                      flag: '🇮🇶' },
    { id: 'nor', name: 'Norvège',            namesq: 'Norvegjia',                  flag: '🇳🇴' },
  ]},
  J: { teams: [
    { id: 'arg', name: 'Argentine',          namesq: 'Argjentina',                 flag: '🇦🇷' },
    { id: 'alg', name: 'Algérie',            namesq: 'Algjeria',                   flag: '🇩🇿' },
    { id: 'aut', name: 'Autriche',           namesq: 'Austria',                    flag: '🇦🇹' },
    { id: 'jor', name: 'Jordanie',           namesq: 'Jordania',                   flag: '🇯🇴' },
  ]},
  K: { teams: [
  ...
  L: { teams: [
    { id: 'eng', name: 'Angleterre',         namesq: 'Anglia',                     flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿' },
    { id: 'cro', name: 'Croatie',            namesq: 'Kroacia',                    flag: '🇭🇷' },
    { id: 'gha', name: 'Ghana',              namesq: 'Gana',                       flag: '🇬🇭' },
    { id: 'pan', name: 'Panama',             namesq: 'Panamaja',                   flag: '🇵🇦' },
  ]},
};
