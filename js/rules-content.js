...
<p>Le total de points inclut <strong>tous les pronostics</strong> : matchs de groupes, phase éliminatoire (avec multiplicateurs) et les deux pronostics bonus (vainqueur + meilleur buteur).</p>
...
<p>Totali i pikëve përfshin <strong>të gjitha parashikimet</strong>: ndeshjet e grupeve, fazën eliminuese (me shumëzues) dhe dy parashikimet bonus (fituesi + golëshënuesi më i mirë).</p>
