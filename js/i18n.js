...
const TRANSLATIONS = {
  fr: {
    ...
    'ko.elim':             '🏆 Élim.',
    'todo.title':          '⏰ À pronostiquer',
    'todo.empty':          'Tous tes pronostics sont à jour ! 🎉',
    'save':                'Enregistrer',
    'saved':               '✓ Sauvegardé',
    'save.error':          '✗ Erreur',
  ...
  sq: {
    ...
    'ko.elim':             '🏆 Elim.',
    'todo.title':          '⏰ Për të parashikuar',
    'todo.empty':          'Të gjitha parashikimet janë të plota! 🎉',
    'save':                'Ruaj',
    'saved':               '✓ Ruajtur',
    'save.error':          '✗ Gabim',
