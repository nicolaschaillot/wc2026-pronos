...
const TRANSLATIONS = {
  ...
  sq: {
    'header.title':        'Pronostike · Kupa e Botës 2026',
    'login.title':         'Pronostike · Kupa e Botës 2026',
    'login.subtitle':      'Shkruaj pseudonimin dhe kodin e marrë për të marrë pjesë.',
    ...
    'nav.pronos':          '⚽ Pronostiket e mia',
    'nav.leaderboard':     '🏅 Renditja',
    'nav.logout':          'Dil',
    'tz.note':             '🕐 Oraret shfaqen në orën lokale Francë / Shqipëri (UTC+2 në verë)',
    'group.label':         'Grupi',
    ...
    'round.1/32':          '1/32 e finalit',
    'round.1/16':          '1/16 e finalit',
    'round.1/4':           'Çerekfinalja',
    'round.1/2':           'Gjysmëfinalja',
    'round.Petite finale': 'Finalja e vogël',
    'round.Finale':        'Finalja',
    'sidebar.missing':     n => `${n} pronostik${n > 1 ? 'e' : ''} mungon${n > 1 ? 'ë' : ''}`,
    'sidebar.complete':    'Të gjitha pronostiket janë futur',
    'lb.title':            '🏅 Renditja',
    'lb.subtitle':         'Përditësohet në kohë reale pas çdo rezultati të futur.',
    'lb.legend.exact':     '🎯 Rezultat i saktë',
    'lb.legend.correct':   '✅ Fitues i saktë',
    'lb.legend.wrong':     '❌ Gabim',
    'lb.legend.phases':    '🏆 Faza finale',
    'lb.col.rank':         'Vendi',
    ...
    'lb.pts':              'pikë',
    'lb.exacts':           'saktë',
    'lb.pronos':           'pronostike',
    'footer.left':         '🇫🇷 🇦🇱 Pronostike mes kolegëve · Keendoo',
